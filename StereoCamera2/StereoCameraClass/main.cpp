...
int main()
{
	...
	std::string pic_filename = "I:\\StereoCamera\\StereoCamera2\\StereoCamera2\\calib_pic2";
	std::string test_pic_filename = "I:\\StereoCamera\\StereoCamera2\\StereoCamera2\\test_pic";
	...
	/*立体校正 运行一次即可*/
	//stereoCamera->stereoCameraRectify(stereoCamera->getCameraMatrix(),stereoCamera->getCameraMatrix(), intrinsic_filename, extrinsic_filename);
